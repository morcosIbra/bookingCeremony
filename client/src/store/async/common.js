...
const getMetaData = function* () {
    try {
        ...
        const info = {
            title: 'معلومات مهمه',
            home: [
                'يمكنك حجز موعد (قداس / مناسبه / بصخه) لاكثر من شخص عن طريق ادخال الرقم القومي لكل منهم',
                'كل (قداس / مناسبه / بصخه) له عدد محدد من الحضور حتي نضمن سلامه الشعب في ظل الظروف الحاليه',
                `كل شخص له الحق في (قداس / مناسبه / بصخه) واحد فقط في فتره من ${dayMonthFormat(currentPhase.start)} وحتي ${dayMonthFormat(currentPhase.end)}`,
            ...
            members: ['يمكنك حجز موعد (قداس / مناسبه / بصخه) لاكثر من شخص عن طريق ادخال الرقم القومي لكل منهم'],
            events: [
                `كل شخص له الحق في (قداس / مناسبه / بصخه) واحد فقط في فتره من ${dayMonthFormat(currentPhase.start)} وحتي ${dayMonthFormat(currentPhase.end)}`,
                'يمكنك تغيير الحجز أو الغاءه في حاله عدم امكانيه الذهاب في الموعد الذي تم حجزه',
            ],
